        ...
        <div className="col-lg-8 mx-auto">
          ...
          <section className="mb-5">
            ...
            <div className="alert alert-light border">
              ...
              <p>PoolBot Reviews is a participant in the <strong>Amazon Services LLC Associates Program</strong>, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com. As an Amazon Associate, I earn from qualifying purchases.</p>
              <p>We are also a participant in the <strong>Best Buy Affiliate Program</strong>. Links to Best Buy on this website are affiliate links, meaning we may earn a commission if you click through and make a purchase.</p>
          ...
          <section className="mb-5">
            ...
            <ul>
              ...
              <li><strong>Third-Party Advertisers:</strong> Some of our advertising partners may use cookies and web beacons on our site. Our advertising partners include Amazon and Best Buy. These third-party ad servers or ad networks use technology to the advertisements and links that appear on PoolBot Reviews send directly to your browsers. They automatically receive your IP address when this occurs. Other technologies (such as cookies, JavaScript, or Web Beacons) may also be used by the third-party ad networks to measure the effectiveness of their advertisements and / or to personalize the advertising content that you see.</li>
            </ul>
            <p>PoolBot Reviews has no access to or control over these cookies that are used by third-party advertisers.</p>
          </section>
