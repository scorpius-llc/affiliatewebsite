...
const CATEGORY_RANKING_PATHS = {
  ...
  'red-light-therapy': '/best-of/best-red-light-therapy-devices',
  'sleep-recovery': '/science/sleep-recovery',
  'performance-longevity': '/best-of/best-recovery-tools',
};
...
const CATEGORY_COMPARISON_PATHS = {
  ...
  'red-light-therapy': '/comparisons/red-light-panel-vs-wrap',
  'sleep-recovery': '/guides',
  'performance-longevity': '/comparisons/compression-boots-vs-massage-gun',
};
